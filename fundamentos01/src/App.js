        ...
        return(
            <div className="App" >
                ...
                <div className="Cards">
                    ...
                    <Card titulo="Compenentes aninhados (CloneElement)" cor="#82212e">
                        <FamiliaClone sobrenome="Simpson">
                            <FamiliaMembroClone nome="Home Jay" />
                    ...
                    <Card titulo="Compenentes aninhados (Comunicação direta)" cor="#d1495b">
